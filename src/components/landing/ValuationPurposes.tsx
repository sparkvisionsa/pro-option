    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {purposes.map((item, index) => (
          <div
            key={item.titleKey}
            className="group relative overflow-hidden rounded-2xl border border-primary/10 bg-background/70 p-4 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl animate-in fade-in"
