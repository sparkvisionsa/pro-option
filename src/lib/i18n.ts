...
const valuationCopy: Translation = {
  ...
  contactForm: {
    ...
    valuationMachinery: 'Machinery & equipment valuation (IVS)',
    realEstateValuation: 'Real estate valuation',
    administrativeConsulting: 'Management & strategic consulting',
    technicalConsulting: 'Technical & engineering consulting',
    assetInventory: 'Asset inventory & tagging',
    educationalConsulting: 'Statistical & educational consulting',
    other: 'Other',
    message: 'Details',
...
const valuationCopyAr: Translation = {
  ...
  hero: {
    ...
    consultation: 'طلب استشارة مجانية',
  ...
  ourServices: {
    ...
    tag: 'شركة استشارات مهنية سعودية متكاملة — تجمع تحت سقف واحد خبرات إدارية وفنية وتقييمية وإحصائية.',
  ...
  values: {
    ...
    /* aliases used by Values.tsx */
    integrity:        'النزاهة',
    integrityDesc:    'ننقل الواقع مدعوماً بالأدلة بعيداً عن التحيز.',
    ...
    fairness:         'الإنصاف',
    fairnessDesc:     'رؤى متوازنة تحترم جميع الأطراف وتعكس حالة الأصل.',
    quality:          'الجودة',
    qualityDesc:      'مراجعة مستمرة، تسليم ثنائي اللغة، وتناسق في كل مشروع.',
  },
  successStories: {
  ...
  contactForm: {
    ...
    valuationMachinery: 'تقييم الآلات والمعدات وفق IVS',
    realEstateValuation: 'تقييم العقارات',
    administrativeConsulting: 'استشارات إدارية واستراتيجية',
    technicalConsulting: 'استشارات فنية وهندسية',
    assetInventory: 'حصر وجرد وترميز الأصول',
    educationalConsulting: 'استشارات إحصائية وتربوية',
    other: 'أخرى',
    message: 'التفاصيل',
  ...
  process: {
    ...
    step3Sub: 'التحقق من الوجود والحالة والأرقام المتسلسلة وتوثيق الصور الجغرافية.',
    ...
    step6Sub: 'تسليم تقرير ثنائي اللغة متوافق مع IVS مع تسويات وملحقات.',
  },
  purposes: {
